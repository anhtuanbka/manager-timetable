 ...
 * @author My PC
 */
public class dlgDeviceInRoom extends javax.swing.JDialog {

    /**
     * Creates new form dlgDeviceInRoom
     */
    private static String roomID;
    private static DefaultTableModel tblModel;
    
    public dlgDeviceInRoom(java.awt.Frame parent, boolean modal,String id) {
        super(parent, modal);
        initComponents();
        roomID=id;
        loadTable(id);
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(tblDeviceInRoom);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgDeviceInRoom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgDeviceInRoom dialog = new dlgDeviceInRoom(new javax.swing.JFrame(), true,roomID);
